Readme for: CS 646 Project
1. Name: 				Sherman Marshall
2. Description:				The app developed is a basic prototype for a home security system.
					...
					the included code.
3. Third party libraries:		The prototype device uses OpenCV for image processing, and is included
					for completeness; however, any device conforming to the above protocol 
					should be sufficient.
					OpenCV website: http://opencv.org/
4. Bugs:				a.	The thread started by the run method on the ConnectionManager object has
